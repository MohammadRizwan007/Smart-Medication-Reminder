...
public class Doctor_setting_module extends AppCompatActivity {

    private CardView user_info, user_resetPass, user_VwReport, user_guidance, user_MedHistory;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_doctor_setting_module);

        closeButton = (ImageView) findViewById(R.id.Img_cls);

        //card_view handler
        user_info = (CardView) findViewById(R.id.DocviewInfor);
        user_resetPass = (CardView) findViewById(R.id.DocresetPass);
        user_guidance = (CardView) findViewById(R.id.Dochelp);
        user_VwReport = (CardView) findViewById(R.id.DocViewreport);
        //user_MedHistory = (CardView) findViewById(R.id.medHis);
        user_signOut = (Button) findViewById(R.id.btn_LogoutDoc);
        ...
        user_info.setOnClickListener(new View.OnClickListener() {
          ...
          Intent i = new Intent(getApplicationContext(),DoctorDetail.class);
          startActivity(i);
            }
        });
...
//                startActivity(i);
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        currentUser.updatePassword(new_Password).addOnSuccessListener(new OnSuccessListener<Void>() {
                            ...
                            public void onSuccess(Void aVoid) {
                                Toast.makeText(Doctor_setting_module.this, "Successfully Reset Password", Toast.LENGTH_SHORT).show();
                            }
                        }).addOnFailureListener(new OnFailureListener() {
                            @Override
                            public void onFailure(@NonNull Exception e) {
                                Toast.makeText(Doctor_setting_module.this, "Password Reset UnsuccessFul ", Toast.LENGTH_SHORT).show();
                            }
                        });
                    }
                });
        ...
        //3) guidance or help OnClickListener
        user_guidance.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                popUPHelp.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        Toast.makeText(Doctor_setting_module.this, "Thanks For Your Concern", Toast.LENGTH_SHORT).show();
                    }
                });
        ...
        //4) SignOUT OnClickListener
        user_signOut.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                FirebaseAuth.getInstance().signOut();
                Intent intent = new Intent(Doctor_setting_module.this, MainActivity.class);
